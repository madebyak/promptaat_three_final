...
// Data for the creativity chart
const creativityData = [
  { date: 'Jan 1', basic: 65, pro: 72 },
  { date: 'Jan 15', basic: 68, pro: 74 },
  { date: 'Feb 1', basic: 70, pro: 77 },
  { date: 'Feb 15', basic: 72, pro: 80 },
  { date: 'Mar 1', basic: 74, pro: 82 },
  { date: 'Mar 21', basic: 75, pro: 85 }, // current value
]
...
interface CreativityChartProps {
  isRTL?: boolean;
}

export default function CreativityChart({ isRTL = false }: CreativityChartProps) {
